...
#
# ultra96v2.tcl: Tcl script for re-creating project 'ultra96v2'
#
# Generated by Vivado on Thu Jan 09 15:17:59 PST 2020
...
#
# 1. This project restoration tcl script (ultra96v2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/data/mpv/ultra96v2_pkg/firmware/ultra96v2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set files [list \
 [file normalize "${origin_dir}/ultra96v2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.845865",
   "Default View_TopLeft":"1,-26",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 480 -y 270 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -x 110 -y 270 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 3 -x 840 -y 270 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 4 -x 1140 -y 280 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 4 -x 1140 -y 100 -defaultsOSRD
preplace inst proc_sys_reset_2 -pg 1 -lvl 4 -x 1140 -y 460 -defaultsOSRD
preplace netloc xlconcat_0_dout 1 1 1 N 270
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 2 1 N 280
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 740 180 950
preplace netloc clk_wiz_0_clk_out1 1 3 1 N 240
preplace netloc clk_wiz_0_locked 1 3 1 960 140n
preplace netloc clk_wiz_0_clk_out2 1 3 1 940 60n
preplace netloc clk_wiz_0_clk_out3 1 3 1 940 280n
levelinfo -pg 1 0 110 480 840 1140 1330
pagesize -pg 1 -db -bbox -sgen 0 0 1330 560
"
}
  ...
  set_property PFM.CLOCK {clk_out1 {id "0" is_default "true" proc_sys_reset "/proc_sys_reset_0" status "fixed"} clk_out2 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_1" status "fixed"} clk_out3 {id "2" is_default "false" proc_sys_reset "/proc_sys_reset_2" status "fixed"}} [get_bd_cells /clk_wiz_0]
...
cr_bd_design_1 ""
set_property PFM_NAME "vendor:lib:design_1:1.0" [get_files design_1.bd ] 
